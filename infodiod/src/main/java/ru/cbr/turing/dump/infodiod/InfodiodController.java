...
public class InfodiodController {
    ...
    public InfodiodServiceClient.SendDumpByInfodiodReport dumpCreated(@RequestBody InfodiodServiceClient.Order order){
        ...
        return new InfodiodServiceClient.DumpCreatedResponse(message, fileNames);
    }
}
